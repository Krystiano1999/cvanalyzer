        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex mt-3 items-center justify-center">
                <Link
                    ...
                    class="ms-4 font-semibold text-cyan-600 hover:text-cyan-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 text-center"
                    >Nie masz konta? <br>Zarejestruj swoją firmę</Link
                >
            </div>
        </form>
    </EmployerFormLayout>           
